...
**4.** Создала Makefile со следующим содержанием:(рис. [-@fig:006])
...
**6.** С помощью утилиты splint попробовала проанализировать коды файлов calculate.c и main.c.(рис. [-@fig:019])
